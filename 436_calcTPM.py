...
#Note: Analyze 436 and 438 seperately as they use different polymerases and starting material for amplificaiton, could affect analysis.
...
#Take log2TPM values and calc the mean, std of the 3 med depth sequencing replicates
def calcMeanTPM(df):
    df["meanTPM"] = 0
...
def main():
    ...
    for idx,file in enumerate(HUMAN_436):
        ...
        human_geneExp.data.to_csv(PATH_RESULTS + human_geneExp.fname_short + human_geneExp.species + ".csv")
    ...
    for idx,file in enumerate(MOUSE_436):
        ...
        mouse_geneExp.data.to_csv(PATH_RESULTS + mouse_geneExp.fname_short + mouse_geneExp.species + ".csv")
